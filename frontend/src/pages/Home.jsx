          ...
          >
            ...
            >
              <div className="relative">
                <div className="w-32 h-32 mx-auto rounded-3xl flex items-center justify-center shadow-lg overflow-hidden relative z-10">
                  <img src="/nawi-logo.png" alt="Nawi Logo" className="w-28 h-28 object-contain" />
                </div>
                <motion.div
                  animate={{
                    scale: [1, 1.1, 1],
                  ...
                  className="absolute inset-0 w-32 h-32 bg-gradient-to-br from-nawi-blue to-nawi-purple rounded-3xl blur-2xl -z-10"
                />
              </div>
            </motion.div>
            ...
            >
              <img src="/nawi-text-logo.png" alt="Nawi" className="h-32 md:h-48 lg:h-56 object-contain" />
            </motion.div>
